...
package BRBON.Item.Int_64 is
   ...
   function Get_Int_64 (C: Container.Instance; Item_Offset: Unsigned_32) return Integer_64;
   pragma Inline (Get_Int_64);

   procedure Set_Int_64 (C: Container.Instance; Item_Offset: Unsigned_32; Value: Integer_64);
