...
package BRBON.Block.Header is
   ...
   --
   procedure Set_Block_Type (C: in out BRBON.Container.Instance; Value: BRBON.Block.Instance_Type);
   pragma inline (Set_Block_Type);

   -- Returns the raw value of the block type.
   --
   function Get_Block_Type (C: in out BRBON.Container.Instance) return BRBON.Block.Instance_Type;
   pragma inline (Get_Block_Type);

   -- Set the value for the first reserved field in the block header.
   --
   procedure Set_Block_Options (C: in out BRBON.Container.Instance; Value: Options);
   pragma inline (Set_Block_Options);

   -- Returns the value of the first reserved field in the block header.
   --
   function Get_Block_Options (C: in out BRBON.Container.Instance) return Options;
