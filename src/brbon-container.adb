...
package body BRBON.Container is
   ...
   function Store_Factory (Buffer_Ptr: Array_Of_Unsigned_8_Ptr; Path: String; Using_Endianness: Endianness) return Store is
   ...
   procedure Write_to_File (S: in out Store'Class; Path: String) is
      File: Ada.Streams.Stream_IO.File_Type;
   ...
   procedure Test_Support_Get_Bytes (S: in out Store; Start: Unsigned_32; Dest: out Array_Of_Unsigned_8) is
   ...
   procedure Set_Item_Type (S: in out Store'Class; Offset: Unsigned_32; Value: BR_Item_Type) is
   begin
      S.Data (Offset) := To_Unsigned_8 (Value);
   end Set_Item_Type;

   function Valid_Item_Type (S: Store'Class; Offset: Unsigned_32) return Boolean is
   ...
   function Get_Item_Type (S: Store'Class; Offset: Unsigned_32) return BR_Item_Type is
   begin
   ...
   procedure Set_Item_Options (S: in out Store'Class; Offset: Unsigned_32; Value: BR_Item_Options) is
   begin
      S.Data (Offset) := To_Unsigned_8 (Value);
   end Set_Item_Options;

   function Get_Item_Options (S: Store'Class; Offset: Unsigned_32) return BR_Item_Options is
   begin
      return To_BR_Item_Options (S.Data (Offset));
   end Get_Item_Options;


   procedure Set_Item_Flags (S: in out Store'Class; Offset: Unsigned_32; Value: BR_Item_Flags) is
   begin
      S.Data (Offset) := To_Unsigned_8 (Value);
   end Set_Item_Flags;

   function Get_Item_Flags (S: Store'Class; Offset: Unsigned_32) return BR_Item_Flags is
   begin
      return To_BR_Item_Flags (S.Data (Offset));
   end Get_Item_Flags;


   procedure Set_Bool (S:in out Store'Class; Offset: Unsigned_32; Value: Boolean) is
   begin
   ...
   procedure Set_Unsigned_8 (S: in out Store'Class; Offset: Unsigned_32; Value: Unsigned_8) is
   begin
      S.Data (Offset) := Value;
   end Set_Unsigned_8;
   ...
   procedure Set_Unsigned_16 (S: in out Store'Class; Offset: Unsigned_32; Value: Unsigned_16) is
   begin
      if S.Swap then
   ...
   procedure Set_Unsigned_32 (S: in out Store'Class; Offset: Unsigned_32; Value: Unsigned_32) is
   begin
      if S.Swap then
   ...
   procedure Set_Unsigned_64 (S: in out Store'Class; Offset: Unsigned_32; Value: Unsigned_64) is
   begin
      if S.Swap then
   ...
   procedure Set_Integer_8 (S: in out Store'Class; Offset: Unsigned_32; Value: Integer_8) is
   begin
      S.Data (Offset) := To_Unsigned_8 (Value);
   end Set_Integer_8;
   ...
   procedure Set_Integer_16 (S: in out Store'Class; Offset: Unsigned_32; Value: Integer_16) is
   begin
      if S.Swap then
   ...
   procedure Set_Integer_32 (S: in out Store'Class; Offset: Unsigned_32; Value: Integer_32) is
   begin
      if S.Swap then
   ...
   procedure Set_Integer_64 (S: in out Store'Class; Offset: Unsigned_32; Value: Integer_64) is
   begin
      if S.Swap then
   ...
   procedure Set_Float_32 (S: in out Store'Class; Offset: Unsigned_32; Value: IEEE_Float_32) is
   begin
      if S.Swap then
   ...
   procedure Set_Float_64 (S: in out Store'Class; Offset: Unsigned_32; Value: IEEE_Float_64) is
   begin
      if S.Swap then
   ...
   procedure Set_String (S: in out Store'Class; Offset: Unsigned_32; Value: String) is
   ...
   function Get_Unsigned_8_Array (S: Store'Class; Offset: Unsigned_32; Length: Unsigned_32) return Array_Of_Unsigned_8 is
   begin
      return S.Data (Offset .. Offset + Length - 1);
   end Get_Unsigned_8_Array;


   procedure Set_Unsigned_8_Array (S: in out Store'Class; Offset: Unsigned_32; Value: Array_Of_Unsigned_8) is
   begin
