...
package Serializable is
   ...
   -- A mask/flag array for some operations.
   --
   ...
   -- @returns The new instance.
   --
   function Create_With_Copy (Copy_Bytes_From: BRBON.Unsigned_8_Array) return Instance;
   ...
   -- @returns The new instance
   --
   function Create_Without_Copy (Use_In_Place: BRBON.Unsigned_8_Array_Ptr; First: Unsigned_32; Last: Unsigned_32) return Instance;
   ...
   --
   function Compare (Source: in out Instance; Expected_Values: BRBON.Unsigned_8_Array) return Boolean;
   ...
   --
   function Compare (Source: in out Instance; Expected_Values: BRBON.Unsigned_8_Array; Dont_Care: Boolean_Array) return Boolean;
...
private
   ...
   type Instance is tagged
      record
         Base_Ptr: BRBON.Unsigned_8_Array_Ptr;
         First: Unsigned_32;
         Cursor: Unsigned_32;
         Last: Unsigned_32;
