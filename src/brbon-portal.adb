...
package body BRBON.Portal is
   ...
   begin
      return (Cptr, Using_Item_Offset, Of_Type, Element_Index, Column_Index);
   end Factory;
   ...
   begin
      return Item.Value_Offset (P.CPtr, P.Item_Offset);
   end Value_Offset;
