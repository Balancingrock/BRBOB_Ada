...
with Byte_Source; use Byte_Source;
...
private
   ...
   --
   function Crc_16 (Source: in out Byte_Source.Byte_Source'Class; Initalization: Unsigned_16 := 0; Polynomial: Unsigned_16 := 16#A001#) return Unsigned_16;
   ...
   --
   function Crc_32 (Source: in out Byte_Source.Byte_Source'Class; Initalization: Unsigned_32 := 16#FFFF_FFFF#) return Unsigned_32;
