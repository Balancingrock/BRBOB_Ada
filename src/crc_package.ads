...
private
   ...
   --
   function Calculate_CRC_16 (Source: in out Serializable.Instance; Initalization: Unsigned_16 := 0; Polynomial: Unsigned_16 := 16#A001#) return CRC_16;
   ...
   --
   function Calculate_CRC_32 (Source: in out Serializable.Instance; Initalization: Unsigned_32 := 16#FFFF_FFFF#) return CRC_32;
