...
package BRBON.Item is
   ...
   function Get_Options (C: in out Container.Instance; Item_Offset: Unsigned_32) return Types.Item_Options;
   pragma Inline (Get_Options);

   function Get_Flags (C: in out Container.Instance; Item_Offset: Unsigned_32) return Types.Item_Flags;
   pragma Inline (Get_Flags);

   function Get_Name_Field_Byte_Count (C: in out Container.Instance; Item_Offset: Unsigned_32) return Unsigned_8;
   pragma Inline (Get_Name_Field_Byte_Count);

   function Get_Byte_Count (C: in out Container.Instance; Item_Offset: Unsigned_32) return Unsigned_32;
   pragma Inline (Get_Byte_Count);

   function Get_Small_Value (C: in out Container.Instance; Item_Offset: Unsigned_32) return Unsigned_32;
   ...
   procedure Set_Options (C: in out Container.Instance; Item_Offset: Unsigned_32; Value: Types.Item_Options);
   pragma Inline (Set_Options);

   procedure Set_Flags (C: in out Container.Instance; Item_Offset: Unsigned_32; Value: Types.Item_Flags);
   pragma Inline (Set_Flags);

   procedure Set_Name_Field_Byte_Count (C: in out Container.Instance; Item_Offset: Unsigned_32; Value: Unsigned_8);
   pragma Inline (Set_Name_Field_Byte_Count);

   procedure Set_Byte_Count (C: in out Container.Instance; Item_Offset: Unsigned_32; Value: Unsigned_32);
   pragma Inline (Set_Byte_Count);

   procedure Set_Small_Value (C: in out Container.Instance; Item_Offset: Unsigned_32; Value: Unsigned_32);
