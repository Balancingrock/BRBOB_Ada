...
package body BRBON.Header.old is
   ...
   procedure Set_Block_Type (C: in out BRBON.Container.Instance; Value: Block_Type) is
   begin
      C.Set_Unsigned_16 (Block_Type_Offset, To_Unsigned_16 (Value));
   end Set_Block_Type;


   function Get_Block_Type (C: in out BRBON.Container.Instance) return Block_Type is
   begin
      return To_Block_Type (C.Get_Unsigned_16 (Block_Type_Offset));
   end Get_Block_Type;


   procedure Set_Block_Options (C: in out BRBON.Container.Instance; Value: Block_Options) is
   begin
      C.Set_Unsigned_16 (Block_Options_Offset, To_Unsigned_16 (Value));
   end Set_Block_Options;


   function Get_Block_Options (C: in out BRBON.Container.Instance) return Block_Options is
   begin
      return To_Block_Options (C.Get_Unsigned_16 (Block_Options_Offset));
