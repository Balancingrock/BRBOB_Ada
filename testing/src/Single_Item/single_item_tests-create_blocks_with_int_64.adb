...
begin
   ...
   P := T_Object.Add_Root_Item (Of_Type         => BRBON.Types.Int_64_Type,
                                With_Byte_Count => 0,
   ...
   if Static_Unprotected.Get_Type (P) /= Int_64_Type then
      New_Line (2);
      Put_Line ("Expected the type 'Int_64_Type', found:" & Static_Unprotected.Get_Type (P)'Image);
      return Failed;
   end if;
