...
function Create_Blocks_With_UInt_16 (Count: in out Integer) return Test_Result is
...
begin
   ...
   Expected_Bytes.all (16#50# .. 16#67#) :=
     (16#08#, 16#00#, 16#00#, 16#08#,  16#18#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#,
      16#EC#, 16#5D#, 16#04#, 16#55#,  16#49#, 16#6E#, 16#74#, 16#00#
     );
   ...
   P := T_Object.Add_Root_Item (Of_Type         => BRBON.Types.UInt_16_Type,
                           With_Byte_Count => 0,
                           With_Name       => "UInt");
   ...
   if Static_Unprotected.Get_Type (P) /= UInt_16_Type then
      New_Line (2);
      Put_Line ("Expected the type 'UInt_16_Type', found:" & Static_Unprotected.Get_Type (P)'Image);
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_Name (P) /= "UInt" then
      New_Line (2);
      Put_Line ("Expected 'UInt', found: " & Static_Unprotected.Get_Name (P));
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_Byte_Count (P) /= 24 then
      New_Line (2);
      Put_Line ("Expected Byte_Count of 24, found:" & Static_Unprotected.Get_Byte_Count (P)'Image);
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_UInt_16 (P) /= 0 then
      New_Line (2);
      Put_Line ("Expected initial value '0', found:" & Static_Unprotected.Get_UInt_16 (P)'Image);
      return Failed;
   end if;

   Static_Unprotected.Set_UInt_16 (P, 16#3456#);

   if Static_Unprotected.Get_UInt_16 (P) /= 13398 then
      New_Line (2);
      Put_Line ("Expected value '13398', found:" & Static_Unprotected.Get_UInt_16 (P)'Image);
      return Failed;
   end if;

   Expected_Bytes.all (16#50# .. 16#67#) :=
     (16#08#, 16#00#, 16#00#, 16#08#,  16#18#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#00#,  16#56#, 16#34#, 16#00#, 16#00#,
      16#EC#, 16#5D#, 16#04#, 16#55#,  16#49#, 16#6E#, 16#74#, 16#00#
     );
...
end Create_Blocks_With_UInt_16;
