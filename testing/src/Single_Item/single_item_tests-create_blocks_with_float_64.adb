...
function Create_Blocks_With_Float_64 (Count: in out Integer) return Test_Result is
...
begin
   ...
   Expected_Bytes.all (16#50# .. 16#7F#) :=
     (16#0C#, 16#00#, 16#00#, 16#18#,  16#30#, 16#00#, 16#00#, 16#00#,
   ...
   P := T_Object.Add_Root_Item (Of_Type         => BRBON.Types.Float_64_Type,
                                With_Byte_Count => 0,
   ...
   if Static_Unprotected.Get_Type (P) /= Float_64_Type then
      New_Line (2);
      Put_Line ("Expected the type 'Float_64_Type', found:" & Static_Unprotected.Get_Type (P)'Image);
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_Name (P) /= "AnyIntegerAtAll" then
      New_Line (2);
      Put_Line ("Expected 'AnyIntegerAtAll', found: " & Static_Unprotected.Get_Name (P));
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_Byte_Count (P) /= 48 then
      New_Line (2);
      Put_Line ("Expected Byte_Count of 48, found:" & Static_Unprotected.Get_Byte_Count (P)'Image);
      return Failed;
   end if;

   if Static_Unprotected.Get_Value_Area_Byte_Count (P) /= 8 then
      New_Line (2);
      Put_Line ("Expected Value_Area_Byte_Count of 8, found:" & Static_Unprotected.Get_Value_Area_Byte_Count (P)'Image);
      return Failed;
   end if;

   if Static_Unprotected.Get_Float_64 (P) /= 0.0 then
      New_Line (2);
      Put_Line ("Expected initial value '0.0', found:" & Static_Unprotected.Get_Float_64 (P)'Image);
      return Failed;
   end if;

   Static_Unprotected.Set_Float_64 (P, 1.28E12);

   if Static_Unprotected.Get_Float_64 (P) /= 1.28E12 then
      New_Line (2);
      Put_Line ("Expected value '1.28E12', found:" & Static_Unprotected.Get_Float_64 (P)'Image);
      return Failed;
   end if;
   ...
   Expected_Bytes.all (16#50# .. 16#7F#) :=
     (16#0C#, 16#00#, 16#00#, 16#18#,  16#30#, 16#00#, 16#00#, 16#00#,
      ...
      16#74#, 16#65#, 16#67#, 16#65#,  16#72#, 16#41#, 16#74#, 16#41#,
      16#6C#, 16#6C#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#20#,  16#5F#, 16#A0#, 16#72#, 16#42#
     );
...
end Create_Blocks_With_Float_64;
