...
function Create_Blocks_With_CRC_Binary (Count: in out Integer) return Test_Result is
...
begin
   ...
   Expected_Bytes.all (16#50# .. 16#8F#) :=
     (16#10#, 16#00#, 16#00#, 16#10#,  16#40#, 16#00#, 16#00#, 16#00#, -- 8
      ...
      16#89#, 16#00#, 16#0A#, 16#43#,  16#52#, 16#43#, 16#20#, 16#42#, -- 18
      16#69#, 16#6E#, 16#61#, 16#72#,  16#79#, 16#00#, 16#00#, 16#00#, -- 20
   ...
   P := T_Object.Add_Root_Item (Of_Type         => BRBON.Types.CRC_Binary_Type,
                                With_Byte_Count => 20,
                                With_Name       => "CRC Binary");
   ...
   if Static_Unprotected.Get_Type (P) /= CRC_Binary_Type then
      New_Line (2);
      Put_Line ("Expected the type 'CRC_Binary_Type', found:" & Static_Unprotected.Get_Type (P)'Image);
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_Name (P) /= "CRC Binary" then
      New_Line (2);
      Put_Line ("Expected 'CRC Binary', found:" & Static_Unprotected.Get_Name (P));
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_CRC_Binary (P)'Length /= 0 then
      New_Line (2);
      Put_Line ("Expected empty binary found:");
      for B of Static_Unprotected.Get_CRC_Binary (P) loop
         Put (B'Image);
      end loop;
      New_Line;
      return Failed;
   ...
   begin
      Static_Unprotected.Set_CRC_Binary (P, Bytes);

      if Static_Unprotected.Get_CRC_Binary (P) /= Bytes then
         New_Line (2);
         Put ("Expected binary with '1, 2, 3, 11, 12, 13, 21, 22, 23, 40', found:");
         for B of Static_Unprotected.Get_CRC_Binary (P) loop
            Put (B'Image);
         end loop;
         New_Line;
   ...
   if Static_Unprotected.Get_CRC_Binary_CRC (P) /= 1917566871 then
      -- Note: on-line CRC32 calculators often use initial value 0, BRBON uses -1
      New_Line (2);
      Put_Line ("Expected 1917566871 for empty CRC string, found:" & Static_Unprotected.Get_CRC_Binary_CRC (P)'Image);
      return Failed;
   end if;
   ...
   Expected_Bytes.all (16#50# .. 16#8F#) :=
     (
      ...
      16#89#, 16#00#, 16#0A#, 16#43#,  16#52#, 16#43#, 16#20#, 16#42#, -- 18
      16#69#, 16#6E#, 16#61#, 16#72#,  16#79#, 16#00#, 16#00#, 16#00#, -- 20
      16#97#, 16#BF#, 16#4B#, 16#72#,  16#0A#, 16#00#, 16#00#, 16#00#, -- 28
      16#01#, 16#02#, 16#03#, 16#0B#,  16#0C#, 16#0D#, 16#15#, 16#16#, -- 30
      16#17#, 16#28#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#, -- 38
      16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#00#, 16#00#  -- 40
     );

   T_Serializer := T_Object.Test_Serializer;

   if Support.Verify_Array_Of_Unsigned_8 (T_Serializer, Expected_Bytes, Skip_Map) = Failed then
      return Failed;
   end if;
...
end Create_Blocks_With_CRC_Binary;
