...
function Create_Block_With_Null_Type (Count: in out Integer) return Test_Result is
   ...
   Type_1_Block_No_Parameters: Array_Of_Unsigned_8 :=
     (
      ...
      -- Offset 16#50
      16#01#, 16#00#, 16#00#, 16#00#,  16#10#, 16#00#, 16#00#, 16#00#, --50
...
end Create_Block_With_Null_Type;
