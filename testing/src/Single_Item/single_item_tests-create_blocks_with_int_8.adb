...
function Create_Blocks_With_Int_8 (Count: in out Integer) return Test_Result is
...
begin
   ...
   Expected_Bytes.all (16#50# .. 16#6F#) :=
     (16#03#, 16#00#, 16#00#, 16#10#,  16#20#, 16#00#, 16#00#, 16#00#,
   ...
   P := T_Object.Add_Root_Item (Of_Type         => BRBON.Types.Int_8_Type,
                                With_Byte_Count => 0,
   ...
   Static_Unprotected.Set_Int_8 (P, 34);

   if Static_Unprotected.Get_Int_8 (P) /= 34 then
      New_Line (2);
