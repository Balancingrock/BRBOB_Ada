...
function Create_Blocks_With_Float_32 (Count: in out Integer) return Test_Result is
...
begin
   ...
   Expected_Bytes.all (16#50# .. 16#67#) :=
     (
      16#0B#, 16#00#, 16#00#, 16#08#,  16#18#, 16#00#, 16#00#, 16#00#,
   ...
   P := T_Object.Add_Root_Item (Of_Type         => BRBON.Types.Float_32_Type,
                                With_Byte_Count => 0,
                                With_Name       => "Any");
   ...
   if Static_Unprotected.Get_Type (P) /= Float_32_Type then
      New_Line (2);
      Put_Line ("Expected the type 'Float_32_Type', found:" & Static_Unprotected.Get_Type (P)'Image);
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_Name (P) /= "Any" then
      New_Line (2);
      Put_Line ("Expected 'Any', found: " & Static_Unprotected.Get_Name (P));
      return Failed;
   end if;
   ...
   if Static_Unprotected.Get_Float_32 (P) /= 0.0 then
      New_Line (2);
      Put_Line ("Expected initial value '0.0', found:" & Static_Unprotected.Get_Float_32 (P)'Image);
      return Failed;
   end if;

   Static_Unprotected.Set_Float_32 (P, 32.5);

   if Static_Unprotected.Get_Float_32 (P) /= 32.5 then
      New_Line (2);
      Put_Line ("Expected value '32.5', found:" & Static_Unprotected.Get_Float_32 (P)'Image);
      return Failed;
   end if;
   ...
   Expected_Bytes.all (16#50# .. 16#67#) :=
     (
      16#0B#, 16#00#, 16#00#, 16#08#,  16#18#, 16#00#, 16#00#, 16#00#,
      16#00#, 16#00#, 16#00#, 16#00#,  16#00#, 16#00#, 16#02#, 16#42#,
      16#BD#, 16#96#, 16#03#, 16#41#,  16#6E#, 16#79#, 16#00#, 16#00#
     );
...
end Create_Blocks_With_Float_32;
