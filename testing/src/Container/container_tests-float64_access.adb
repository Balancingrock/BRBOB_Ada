...
function Float64_Access (Count: in out Integer) return Test_Result is
   ...
   function Verify (Container: Binary_Store; Location: Unsigned_32; Expected: IEEE_Float_64) return Test_Result is
   ...
   function Test (Container: in out Binary_Store; Location: Unsigned_32; Value: IEEE_Float_64) return Test_Result is
