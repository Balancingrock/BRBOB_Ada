...
function Float32_Access (Count: in out Integer) return Test_Result is
   ...
   function Verify (Container: Storage_area; Location: Unsigned_32; Expected: IEEE_Float_32) return Test_Result is
   ...
   function Test (Container: in out Storage_area; Location: Unsigned_32; Value: IEEE_Float_32) return Test_Result is
