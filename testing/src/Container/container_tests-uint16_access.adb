...
function UInt16_Access (Count: in out Integer) return Test_Result is
   ...
   function Verify (Container: Binary_Store; Location: Unsigned_32; Expected: Unsigned_16) return Test_Result is
   ...
   function Test (Container: in out Binary_Store; Location: Unsigned_32; Value: Unsigned_16) return Test_Result is
