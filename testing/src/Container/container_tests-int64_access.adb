...
function Int64_Access (Count: in out Integer) return Test_Result is
   ...
   function Verify (Container: Store; Location: Unsigned_32; Expected: Integer_64) return Test_Result is
   ...
   function Test (Container: in out Store; Location: Unsigned_32; Value: Integer_64) return Test_Result is
