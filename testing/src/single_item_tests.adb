package body Single_Item_Tests is
   ...
   function Create_Block_With_Null_Type (Count: in out Integer) return Test_Result is separate;
   function Create_Blocks_With_Types (Count: in out Integer) return Test_Result is separate;
